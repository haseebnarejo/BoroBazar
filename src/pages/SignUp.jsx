            ...
            <div className="container">
                <div className='w-full grid grid-cols-12 md:w-[100%] lg:w-[90%] xl:w-[80%] 2xl:w-[80%] my-16 mx-auto lg:border rounded-lg '>
                    <div class="col-span-7 hidden lg:block">
                        <img src="assets/images/sign-up/registration.webp" alt="login img" className='w-full h-full object-cover' />
                    </div>
                    <div class="flex lg:block justify-center col-span-12 lg:col-span-5">
                        <div className='p-10 border lg:boe'>
                            ...
                            <div className='text-center'>
                                ...
                                <p className='text-[15px] text-gray-500'>Already registered?<Link to={"/signin"}><span className='text-theme font-bold'>Sign In Now</span></Link></p>
                            </div>
                            <form className='my-6'>
                                <div class="mb-5">
                                    <label for="text" class="block text-gray-500 font-semibold mb-2 text-sm dark:text-white">Name
                                    </label>
                                    <input type="text" id="text" class=" border h-[45px] w-full px-3 focus:outline-[#02b290] border-gray-300 text-sm rounded-md" required />
                                </div>
                                <div class="mb-5">
                            ...
                            <div className='flex items-center justify-between mb-4'>
                                ...
                                <span className='text-gray-500 font-semibold text-sm'>Privacy and policy</span>

                            </div>
                            <div className='text-center'>
                                <button className='theme-btn w-full h-[48px] rounded-md mb-4'>Register</button>
                            </div>
